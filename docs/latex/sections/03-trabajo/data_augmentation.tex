...
%En \citep{xie2019unsupervised} las clasifica entre las que se basan en un enfoque supervisado y no supervisado, pero se escuyen aquellas técnicas que incorporan ejemplos totalmente nuevos al conjunto de entrenamiento mediante un enfoque semi-supervisado.
