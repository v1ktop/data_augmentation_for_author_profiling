\begin{table}[!hbt]
\caption{Número de usuarios en los conjuntos de datos y número de secuencias con 64 palabras después del preprocesamiento y filtrado. Los números resaltados en negritas representan el número de historiales.} \label{table:filter_users}
