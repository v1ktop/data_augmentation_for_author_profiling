...
def configure_root_logger(prefix_name):
    ...
    LOGS_DIRECTORY = os.path.join(PACKAGE_DIRECTORY, 'logs')
    # Create the directory if it does not exist
    os.makedirs(LOGS_DIRECTORY, exist_ok=True)
    # Assemble the log file name
    LOG_FILE_NAME = prefix_name+datetime.today().strftime('%Y-%m-%d_%H-%M-%S ') + SCRIPT_NAME + '.log'
