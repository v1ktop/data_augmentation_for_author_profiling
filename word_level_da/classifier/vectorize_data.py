...
class vectorize(object):
    ...
    def __init__(self , features=10000, min_doc=2, doc_len=1024, idf=True):
        self.TOP_K=features
        self.MIN_DOCUMENT_FREQUENCY=min_doc
        self.MAX_SEQUENCE_LENGTH=doc_len
        self.use_idf=idf
    
    def ngram_vectorize(self, train_texts, train_labels, val_texts):
